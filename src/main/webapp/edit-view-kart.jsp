...
<form:form action="editkartitem" method="post" modelAttribute="items">
<table align="center" border="1">
		<tr>
				<td>Item:<form:input path="name" readonly="readonly"/><br><br></td></tr>
<tr><td>Cost:<form:input path="cost" readonly="readonly"/><br><br></td></tr>
<tr><td>Enter the Quantity: <form:input path="quantity"/><br><br></td></tr>
