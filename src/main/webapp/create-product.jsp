...
<table align="center" border="1">
			...
			<tr><td colspan="2" align="center">Type:<form:select path="type">
						<option value="burger+coke">Combo</option>
						<option value="burger">Individual</option>
						<option value="burger+fries+coke">Meal</option>
						</form:select><br><br></td>
			</tr>

			<tr>
				<td>Cost:</td><td><form:input path="cost"/><br><br></td>
			</tr>


			<tr><td>Food Type:</td>
				<td><form:radiobutton path="foodtype" value="Veg"/>Veg
				<form:radiobutton path="foodtype" value="nonVeg"/>NonVeg<br><br></td>
			</tr>

			<tr>
				<td>Image:</td>
				<td><form:input path="imagelink"/><br><br></td>
			</tr>
